...
function Post() {
  ...
  // Connect to socket
  useEffect(() => {
    const socketInstance = io(`https://api-blurtbox.basatmaqsood.com/`)
  ...
  useEffect(() => {
    ...
    fetch(`https://api-blurtbox.basatmaqsood.com/api/confessions/${id}`)
      .then((res) => {
        if (!res.ok) {
  ...
  useEffect(() => {
    ...
    const handleErrorMessage = (data) => {
      ...
      if (isSubmitting) {
        ...
        // Clear the reply input if it's a hate speech error
        if (data.message.includes("hate speech")) {
          setNewReply("")
        }
      }
  ...
  }, [socket, id, isSubmitting, commentSubmitted, isSubmittingReply, replyingTo])
                ...
                >
                  ...
                  <div className="p-4 bg-gray-50 dark:bg-gray-700/50">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        onClick={() => startReply(commentIndex, comment.text)}
                  ...
                  {comment.replies && comment.replies.length > 0 && (
                    <div className="border-t border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700">
                      {comment.replies.map((reply, replyIndex) => (
                        <div key={reply._id || replyIndex} className="p-3 pl-6 bg-white dark:bg-gray-800">
                          <div className="flex items-start space-x-2">
                            ...
                            <div className="flex-1">
                              <p className="text-gray-800 dark:text-gray-200 text-sm">{reply.text}</p>
                              {reply.createdAt && (
                    ...
                    <div className="p-3 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                      <form onSubmit={handleSubmitReply} className="space-y-2">
                        <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mb-2">
                          ...
                          <span className="truncate ml-1 font-medium">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              // Check for potential hate speech
                              if (checkForHateSpeech(e.target.value)) {
                                setHateWarning("Your reply may contain inappropriate language. Please be respectful.")
                              } else {
                                setHateWarning("")
                              }
                            }}
